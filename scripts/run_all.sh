CUDA_VISIBLE_DEVICES=0 nohup bash scripts/run_0.sh > ./log/240924_0200_0.log 2>&1 &
sleep 2
CUDA_VISIBLE_DEVICES=1 nohup bash scripts/run_1.sh > ./log/240924_0200_1.log 2>&1 &
sleep 2
CUDA_VISIBLE_DEVICES=2 nohup bash scripts/run_2.sh > ./log/240924_0200_2.log 2>&1 &
sleep 2
CUDA_VISIBLE_DEVICES=3 nohup bash scripts/run_3.sh > ./log/240924_0200_3.log 2>&1 &
#sleep 2
